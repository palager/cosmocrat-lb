...
func main() {
	...
	p.AddHTTPHostRoute(":80", "ssb.cosmocr.at", tcpproxy.To("ssb-pub.scuttlebutt.svc.cluster.local:8080"))
	p.AddSNIRoute(":443", "ssb.cosmocr.at", tcpproxy.To("ssb-pub.scuttlebutt.svc.cluster.local:8443"))
